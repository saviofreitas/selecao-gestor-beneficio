...
import br.gov.seplag.app.gestor.config.audit.AuditEventConverter;
import br.gov.seplag.app.gestor.domain.PersistentAuditEvent;
...
import static br.gov.seplag.app.gestor.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
