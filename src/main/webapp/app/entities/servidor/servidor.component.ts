...
export class ServidorComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.servidorService
      ...
      .subscribe((res: HttpResponse<IServidor[]>) => this.paginateServidors(res.body, res.headers));
  }
  ...
  protected paginateServidors(data: IServidor[], headers: HttpHeaders) {
